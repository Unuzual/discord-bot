...
GUILD_ID = int(os.environ.get("GUILD_ID", "1383082575500677142"))
GENERATION = "7기"  # 기수 변경
...
TRACK_EXTRA_CHANNELS = {
    "크리에이터 숏폼 트랙":          ["숏폼-과제-인증"],
    "크리에이터 롱폼 트랙":          ["롱폼-과제-인증"],
    "크리에이터 라이트 트랙 (숏폼)": ["숏폼-과제-인증"],
    "크리에이터 라이트 트랙 (롱폼)": ["롱폼-과제-인증"],
    "빌더 기초 트랙":                ["과제-인증"],
    "빌더 심화 트랙":                ["과제-인증"],
    "빌더 라이트 트랙 (기초)":       ["과제-인증"],
    "빌더 라이트 트랙 (심화)":       ["과제-인증"],
